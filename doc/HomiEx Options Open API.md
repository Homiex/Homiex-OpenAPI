...
The base url of Homiex open API is: https://www.homiex.com/openapi
...
In the `symbols` field, the endpoint will return information on current actively trading cryptos on Homiex. You can ignore this section.
