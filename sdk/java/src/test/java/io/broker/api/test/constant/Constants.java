...
public class Constants {
    ...
    // FIXME: please change to your valid api domain for test, for example: homiex.com
    public static final String BASE_DOMAIN = "";

    // REST api url format: https://api.BASE_DOMAIN
    // for example: https://api.homiex.com
    ...
    // for example: wss://wsapi.homiex.com/openapi/quote/ws/v1
    ...
    // for example: wss://wsapi.homiex.com/openapi/ws
