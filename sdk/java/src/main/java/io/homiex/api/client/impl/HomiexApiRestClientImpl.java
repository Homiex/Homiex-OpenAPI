...
import io.homiex.api.client.domain.market.*;
import io.homiex.api.client.service.HomiexApiService;
...
/**
 * Implementation of Homiex's REST API using Retrofit with synchronous/blocking method calls.
 */
public class HomiexApiRestClientImpl implements HomiexApiRestClient {

    private final HomiexApiService bHexApiService;

    public HomiexApiRestClientImpl(String baseUrl, String apiKey, String secret) {
        bHexApiService = createService(baseUrl, HomiexApiService.class, apiKey, secret);
    }
