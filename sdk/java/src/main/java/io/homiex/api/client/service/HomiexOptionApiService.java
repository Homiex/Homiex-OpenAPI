...
import io.homiex.api.client.domain.account.OrderStatus;
...
/**
 * Homiex's Option REST API URL mappings and endpoint security configuration.
 */
public interface HomiexOptionApiService {
