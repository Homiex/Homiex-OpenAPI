package io.homiex.api.client.service;
...
import io.homiex.api.client.domain.general.ServerTime;
...
/**
 * Homiex's REST API URL mappings and endpoint security configuration.
 */
public interface HomiexApiService {

    // General endpoints
    @GET("/openapi/quote/v1/ping")
    @Headers(HomiexConstants.ENDPOINT_SECURITY_TYPE_APIKEY_HEADER)
    Call<Void> ping();
    ...
    @Headers(HomiexConstants.ENDPOINT_SECURITY_TYPE_SIGNED_HEADER)
