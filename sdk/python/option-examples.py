...
from homiex.client import HomiexOptionClient
from homiex.exceptions import HomiexRequestException, HomiexAPIException
...
if __name__ == '__main__':
    ...
    b = HomiexOptionClient(api_key='', secret='', proxies=proxies)
    ...
    except HomiexRequestException as bre:
        logging.error(bre)
    except HomiexAPIException as bae:
        logging.error(bae)
